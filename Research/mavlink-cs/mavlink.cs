...
{
    public const string MAVLINK_BUILD_DATE = "Sat Oct 21 2023";
    ...
    {
        public mavlink_trajectory_representation_waypoints_t(ulong time_usec,float[] pos_x,float[] pos_y,float[] pos_z,float[] vel_x,float[] vel_y,float[] vel_z,float[] acc_x,float[] acc_y,float[] acc_z,float[] pos_yaw,float[] vel_yaw,byte valid_points) 
        {
              this.time_usec = time_usec;
              this.pos_x = pos_x;
              this.pos_y = pos_y;
